...
namespace Ufba.visualForm
{
	...
	/// </summary>
	internal partial class visualFormDocData : visualFormDocDataBase
	{
		/// <summary>
		/// Constructs a new visualFormDocData.
		/// </summary>
		public visualFormDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a visualForm document in memory.
	/// </summary>
	internal abstract partial class visualFormDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new visualFormDocDataBase.
		/// </summary>
		protected visualFormDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Ufba.visualForm.visualFormDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Ufba.visualForm.visualFormDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(visualFormExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Ufba.visualForm.visualFormDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Ufba.visualForm.visualFormDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Ufba.visualForm.FormModel modelRoot = null;
			...
			global::Ufba.visualForm.visualFormDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Ufba.visualForm.visualFormSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Ufba.visualForm.visualFormDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Ufba.visualForm.visualFormDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::Ufba.visualForm.visualFormDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Ufba.visualForm.FormModel modelRoot = (global::Ufba.visualForm.FormModel)this.RootElement;
			...
			{
				global::Ufba.visualForm.visualFormDiagram diagram = diagrams[0] as global::Ufba.visualForm.visualFormDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Ufba.visualForm.visualFormSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Ufba.visualForm.visualFormSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Ufba.visualForm.visualFormDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Ufba.visualForm.visualFormSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Ufba.visualForm.FormModel modelRoot = this.RootElement as global::Ufba.visualForm.FormModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Ufba.visualForm.visualFormSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
