...
namespace Ufba.visualForm
{
	...
	/// </summary>
	internal partial class visualFormCommandSet : visualFormCommandSetBase
	{
		/// <summary>
		/// Constructs a new visualFormCommandSet.
		/// </summary>
		public visualFormCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class visualFormCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new visualFormCommandSetBase.
		/// </summary>
		protected visualFormCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewvisualFormExplorerCommand,
				typeof(visualFormEditorFactory).GUID);
		...
		{
			visualFormExplorerToolWindow explorer = this.visualFormExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentvisualFormDocData != null && this.CurrentvisualFormDocData.Store != null)
			{
				this.CurrentvisualFormDocData.ValidationController.Validate(this.CurrentvisualFormDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentvisualFormDocData != null && this.CurrentvisualFormDocData.Store != null)
			{
				...
				this.CurrentvisualFormDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected visualFormDocData CurrentvisualFormDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as visualFormDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected visualFormDocView CurrentvisualFormDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as visualFormDocView;
			}
		}
		...
		/// </summary>
		protected visualFormExplorerToolWindow visualFormExplorerToolWindow
		{
			get
			{
				visualFormExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(visualFormExplorerToolWindow), true) as visualFormExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				visualFormExplorerToolWindow explorerWindow = this.visualFormExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class visualFormClipboardCommandSet : visualFormClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new visualFormClipboardCommandSet.
		/// </summary>
		public visualFormClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class visualFormClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new visualFormClipboardCommandSetBase.
		/// </summary>
		protected visualFormClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
