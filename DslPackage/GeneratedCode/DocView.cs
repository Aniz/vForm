...
namespace Ufba.visualForm
{
	...
	/// </summary>
	internal partial class visualFormDocView : visualFormDocViewBase
	{
		/// <summary>
		/// Constructs a new visualFormDocView.
		/// </summary>
		public visualFormDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class visualFormDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new visualFormDocView.
		/// </summary>
		protected visualFormDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			visualFormDocDataBase docData = this.DocData as visualFormDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for visualFormDocViewBase should be an visualFormDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Ufba.visualForm.visualFormDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Ufba.visualForm.visualFormDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Ufba.visualForm.visualFormToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Ufba.visualForm.visualFormToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.visualFormDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Ufba.visualForm.visualFormHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Ufba.visualForm.visualFormHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Ufba.visualForm.visualFormHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
