...
namespace Ufba.visualForm
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.visualFormEditorFactoryId)]
	internal partial class visualFormEditorFactory : visualFormEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new visualFormEditorFactory.
		/// </summary>
		public visualFormEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class visualFormEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected visualFormEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new visualFormDocData(this.ServiceProvider, typeof(visualFormEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new visualFormDocView(docData, this.ServiceProvider);
		}
	}
}
