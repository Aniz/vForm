...
namespace Ufba.visualForm
{
	...
	/// </remarks>
	public partial class visualFormHelpKeywordHelper : visualFormHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new visualFormHelpKeywordHelper.
		/// </summary>
		protected visualFormHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the visualFormHelpKeywordHelper.
		/// </summary>
		public static visualFormHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class visualFormHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new visualFormHelpKeywordHelperBase.
		/// </summary>
		protected visualFormHelpKeywordHelperBase()
			: base() { }
