...
namespace Ufba.visualForm
{
	...
	/// </remarks>
	public partial class visualFormToolboxHelper : visualFormToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new visualFormToolboxHelper.
		/// </summary>
		public visualFormToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class visualFormToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify visualForm toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "visualForm.1.0";
		...
		/// <summary>
		/// Constructs a new visualFormToolboxHelperBase.
		/// </summary>
		protected visualFormToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Ufba.visualForm.visualFormDomainModel.SingletonResourceManager.GetString("visualFormToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Ufba.visualForm.visualFormDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Ufba.visualForm.FormToolboxItem":
					// Add Form shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Ufba.visualForm.FormToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("FormToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("FormToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Ufba.visualForm.visualFormToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("visualFormToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"CreateExampleClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("FormToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Ufba.visualForm.Form.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Ufba.visualForm.FieldToolboxItem":
					// Add Field shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Ufba.visualForm.FieldToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::Ufba.visualForm.Field.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Ufba.visualForm.OptionToolboxItem":
					// Add Option shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Ufba.visualForm.OptionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						3, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("OptionToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("OptionToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Ufba.visualForm.visualFormToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("visualFormToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"Option", // F1 help keyword for the toolbox item.
						resourceManager.GetString("OptionToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Ufba.visualForm.Option.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Ufba.visualForm.visualFormDomainModel));
